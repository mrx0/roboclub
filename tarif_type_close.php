...
//tarif_type_close.php
//Удаление(блокирование) типы тарифов
			...
			if ($_GET){
				...
				if ($tarif_type_j !=0){
					echo '
						<div id="status">
							<header>
								...
								<h2>Удаление типа тарифов и сборов в архив</h2>
							</header>';
					...
					echo '
								...
								<div id="errror"></div>
								<input type="button" class="b" value="Удалить" onclick="Ajax_del_tarif_type('.$_GET['id'].')">
