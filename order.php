            ...
            if ($_GET){
                if (isset($_GET['id'])){
                    ...
                    if ($order_j != 0){
                        ...
                        $offices_j = SelDataFromDB('spr_office', $order_j[0]['filial_id'], 'offices');
                        ...
                        if (($finance['edit'] == 1) || $god_mode){
                            ...
                            if (($order_j[0]['status'] == 9) && (($finance['close'] == 1) || $god_mode)){
                                echo '
                        ...
                        if ($order_j[0]['status'] == 9){
                            echo '<i style="color:red;">Ордер удалён.</i><br>';
                        }
                        ...
                        if (($order_j[0]['create_time'] != 0) || ($order_j[0]['create_person'] != 0)){
                            echo '
											...
											Автор: '.WriteSearchUser2('spr_workers', $order_j[0]['create_person'], 'user', true).'<br>';
                        }else{
                        ...
                        if (($order_j[0]['last_edit_time'] != 0) || ($order_j[0]['last_edit_person'] != 0)){
                            echo '
											...
											Кем: '.WriteSearchUser2('spr_workers', $order_j[0]['last_edit_person'], 'user', true).'';
                        }
                        echo '
										</span>
									</div>';
